        ...
        <div className="ed-page">
            ...
            <div className="ed-container">
                ...
                <div className="ed-meta-row">
                    {/* Status pill — only visible to admins / organizers */}
                    {isPrivileged && (
                ...
                {(() => {
                    ...
                    const { name, addressLine1, addressLine2, city, state, postalCode, country, latitude, longitude } = venue;
                    ...
                    // All address parts on one line, separated by ", "
                    const addressLine = [name, addressLine1, addressLine2, city, state, postalCode, country]
                        .filter(Boolean).join(', ');

                    return (
                        <section className="ed-section">
                            <h2 className="ed-section-title">Venue &amp; Location</h2>
                            <div className="ed-venue-block">
                                <p className="ed-venue-address-line">{addressLine}</p>

                                {osmEmbedUrl && (
                                    <iframe
                                        className="ed-map-embed"
                                        src={osmEmbedUrl}
                                        title={`Map showing ${name || 'venue location'}`}
                                        allowFullScreen
                                        loading="lazy"
                                    />
                                )}
